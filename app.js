...
var actuatorsPublicUpdate = require('./routes/updateActuators');
...
app.use('/application', [verifyAuth], appRouter);
app.use('/sensors', sensorsRouter);
app.use('/actuators', actuatorsRouter);
app.use('/create', [verifyAuth], createRouter);
app.use('/update', actuatorsPublicUpdate);
